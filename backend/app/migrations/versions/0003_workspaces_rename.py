...
def upgrade() -> None:
    ...
    with op.batch_alter_table("auth_users") as batch:
        ...
        batch.alter_column("tenant_id", new_column_name="workspace_id", existing_type=sa.String(length=64))
...
def downgrade() -> None:
    with op.batch_alter_table("auth_users") as batch:
        ...
        batch.alter_column("workspace_id", new_column_name="tenant_id", existing_type=sa.String(length=64))
